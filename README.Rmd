...
Some functions in this package, especially gamutil::plot_contour, are inspired by [mgcv::plot.gam](https://cran.r-project.org/web/packages/mgcv/index.html), [itsadug::fvisgam](https://cran.r-project.org/web/packages/itsadug/index.html), and [itsadug::pvisgam](https://cran.r-project.org/web/packages/itsadug/index.html).
