#' Return a single value for a predictor you would like to keep to one specific value.
#'
...
#' @param func A function, which should take a numeric vector and returns a single numeric value.
#' @return A new format-like string, from which the terms you specified have been removed.
...
#' print(constant(vec))
#' # The representative value by "func" is returned for numeric (default=median).
#' set.seed(716)
#' vec = rnorm(10)
#' print(constant(vec))
