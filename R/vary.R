...
#'
#' @param vec A vector of numeric, character, or factor, based on which values are produced for prediction.
#' @param len A single numeric value, which indicates how many unique values are required for each of the varied variables.
#' @return A vector of numeric or character (depending on the class of "vec" provided).
